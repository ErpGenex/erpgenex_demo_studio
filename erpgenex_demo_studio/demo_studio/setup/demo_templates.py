...
INDUSTRY_TEMPLATE_CATALOG = [
	...
	{
		"industry": "Education",
		"template_name": "University - Multi-College Annual Demo",
		"description": "Twelve-month university demo with multiple colleges (Engineering, Medicine, Business, Arts, Science), 200 students per college, complete academic operations, research, and campus management.",
		"branch_count": 8,
		"employee_count": 250,
		"customer_count": 1000,
		"supplier_count": 150,
		"transactions_per_month": 320,
		"business_activity": "Education",
		"industry_sector": "Higher Education",
		"branch_names": ["Main Campus", "Engineering College", "Medical College", "Business School", "Arts College", "Science College", "Research Center", "Student Housing"],
		"department_names": [
			"Academic Affairs",
			"Admissions",
			"Student Services",
		...
		"seasonality": "Academic year driven with enrollment peaks before semesters, fee collection at term start, research grants throughout year.",
		"monthly_weights": [0.04, 0.06, 0.09, 0.10, 0.11, 0.12, 0.14, 0.10, 0.09, 0.08, 0.12, 0.05],
		"kpi_focus": ["Enrollment", "Research Grants", "Graduation Rate", "Student Satisfaction", "Faculty Utilization"],
		"report_profiles": [
		...
		"sample_data_seed": {
			**BASE_SAMPLE_DATA_SEED,
			...
			"colleges": 5,
			"courses": 80,
			"research_projects": 40,
		},
	},
	{
		"industry": "Education",
		"template_name": "International School - Annual Demo",
		"description": "Twelve-month international school demo with 500 students, multi-curriculum (IB, British, American), complete K-12 operations, boarding facilities, and international student management.",
		"branch_count": 4,
		"employee_count": 120,
		"customer_count": 500,
		"supplier_count": 80,
		"transactions_per_month": 180,
		"business_activity": "Education",
		"industry_sector": "K-12 Education",
		"branch_names": ["Main Campus", "Primary School", "Secondary School", "Boarding Facility"],
		"department_names": [
			"Academic Affairs",
			"Admissions",
			"Student Services",
		...
		"seasonality": "Academic year driven with enrollment before term start, tuition collection quarterly, continuous boarding operations.",
		"monthly_weights": [0.06, 0.07, 0.09, 0.10, 0.11, 0.12, 0.13, 0.10, 0.09, 0.08, 0.12, 0.05],
		"kpi_focus": ["Enrollment", "Attendance", "Fee Collection", "Student Retention", "Curriculum Completion"],
		"report_profiles": [
			"Student enrollment by grade",
			"International student dashboard",
			"Boarding facility utilization",
	...
	{
		"industry": "Education",
		"template_name": "Institute - Annual Demo",
		"description": "Twelve-month technical/vocational institute demo with 200 students, skill-based programs, certification tracking, and industry partnership management.",
		"branch_count": 3,
		"employee_count": 45,
		"customer_count": 200,
		"supplier_count": 40,
		...
		"business_activity": "Education",
		"industry_sector": "Vocational Training",
		"branch_names": ["Main Campus", "Training Center", "Industry Partnership Office"],
		"department_names": [
			"Academic Affairs",
			"Admissions",
			"Student Services",
		...
		"seasonality": "Program-based cycles with intake periods, certification exams, continuous industry training partnerships.",
		"monthly_weights": [0.07, 0.08, 0.09, 0.10, 0.11, 0.12, 0.11, 0.10, 0.09, 0.08, 0.12, 0.05],
		"kpi_focus": ["Enrollment", "Certification Rate", "Industry Placement", "Program Completion", "Partner Satisfaction"],
		"report_profiles": [
			"Program enrollment dashboard",
			"Certification tracking report",
	...
	{
		"industry": "Education",
		"template_name": "Academy - Annual Demo",
		"description": "Twelve-month professional academy demo with 200 students, specialized programs (IT, Business, Languages), flexible scheduling, and corporate training partnerships.",
		"branch_count": 3,
		"employee_count": 40,
		"customer_count": 200,
		"supplier_count": 35,
		...
		"business_activity": "Education",
		"industry_sector": "Professional Training",
		"branch_names": ["Main Campus", "Corporate Training Center", "Online Learning Hub"],
		"department_names": [
			"Academic Affairs",
			"Admissions",
			"Student Services",
		...
		"seasonality": "Flexible intake periods with corporate training cycles, evening/weekend programs, continuous enrollment.",
		"monthly_weights": [0.08, 0.08, 0.09, 0.10, 0.11, 0.11, 0.10, 0.10, 0.09, 0.08, 0.12, 0.05],
		"kpi_focus": ["Enrollment", "Course Completion", "Corporate Satisfaction", "Student Retention", "Revenue per Student"],
		"report_profiles": [
			"Program enrollment dashboard",
			"Corporate training utilization",
	...
	{
		"industry": "Education",
		"template_name": "Training Center - Annual Demo",
		"description": "Twelve-month training center demo with 200 students, short-term courses, workshop management, equipment tracking, and certification programs.",
		"branch_count": 2,
		"employee_count": 35,
		"customer_count": 200,
		"supplier_count": 30,
		...
		"business_activity": "Education",
		"industry_sector": "Training & Development",
		"branch_names": ["Main Training Center", "Satellite Center"],
		"department_names": [
			"Training Operations",
			"Admissions",
			"Student Services",
		...
		"seasonality": "Continuous short-term courses with workshop cycles, equipment maintenance, certification testing periods.",
		"monthly_weights": [0.08, 0.08, 0.09, 0.10, 0.11, 0.11, 0.10, 0.10, 0.09, 0.08, 0.12, 0.05],
		"kpi_focus": ["Course Enrollment", "Workshop Utilization", "Equipment Availability", "Certification Pass Rate", "Customer Satisfaction"],
		"report_profiles": [
			"Course enrollment dashboard",
			"Workroom utilization report",
			"Equipment maintenance schedule",
			"Certification tracking summary",
	...
	{
		"industry": "Healthcare",
		"template_name": "Multi-Department Hospital - Annual Demo",
		"description": "Twelve-month multi-department hospital demo with 500 patients, comprehensive departments (ER, ICU, Surgery, Pediatrics, Cardiology, Orthopedics, Radiology, Lab), complete hospital operations.",
		"branch_count": 6,
		"employee_count": 280,
		"customer_count": 500,
		"supplier_count": 200,
		"transactions_per_month": 350,
		"business_activity": "Healthcare",
		"industry_sector": "Hospital Care",
		"branch_names": ["Main Hospital", "Emergency Center", "Surgical Wing", "Outpatient Clinic", "Diagnostic Center", "Administrative Building"],
		"department_names": [
			"Emergency",
			"ICU",
			"Surgery",
		...
		"seasonality": "Continuous hospital operations with seasonal variations in admissions, elective surgery scheduling, emergency care steady year-round.",
		"monthly_weights": [0.08, 0.08, 0.08, 0.08, 0.09, 0.09, 0.09, 0.09, 0.08, 0.09, 0.08, 0.08],
		"kpi_focus": ["Patient Volume", "Bed Occupancy", "Average Length of Stay", "Readmission Rate", "Patient Satisfaction"],
		"report_profiles": [
			"Department utilization dashboard",
			"Patient census by department",
			"Surgery scheduling efficiency",
	...
	{
		"industry": "Healthcare",
		"template_name": "Private Clinic - Annual Demo",
		"description": "Twelve-month private clinic demo with 200 patients, specialized services (General Practice, Pediatrics, Dermatology, Cardiology), appointment management, and personalized care.",
		"branch_count": 2,
		"employee_count": 35,
		"customer_count": 200,
		"supplier_count": 40,
		"transactions_per_month": 120,
		"business_activity": "Healthcare",
		"industry_sector": "Outpatient Care",
		"branch_names": ["Main Clinic", "Satellite Clinic"],
		"department_names": [
			"General Practice",
			"Pediatrics",
			"Dermatology",
		...
		"seasonality": "Steady outpatient flow with seasonal variations in respiratory illnesses, dermatology, and routine check-ups.",
		"monthly_weights": [0.07, 0.08, 0.09, 0.09, 0.10, 0.10, 0.10, 0.09, 0.09, 0.08, 0.08, 0.07],
		"kpi_focus": ["Patient Volume", "Appointment Show Rate", "Patient Satisfaction", "Revenue per Visit", "Referral Rate"],
		"report_profiles": [
			"Patient visit trends",
			"Appointment utilization dashboard",
	...
	{
		"industry": "Healthcare",
		"template_name": "Hospital Network - Annual Demo",
		"description": "Twelve-month hospital network demo with 10 hospitals, centralized management, shared resources, inter-hospital referrals, and network-wide analytics.",
		"branch_count": 12,
		"employee_count": 1200,
		"customer_count": 5000,
		"supplier_count": 500,
		"transactions_per_month": 1500,
		"business_activity": "Healthcare",
		"industry_sector": "Hospital Network",
		"branch_names": ["Network Headquarters", "Hospital 1 - General", "Hospital 2 - Surgical", "Hospital 3 - Pediatric", "Hospital 4 - Cardiac", "Hospital 5 - Orthopedic", "Hospital 6 - Maternity", "Hospital 7 - Rehabilitation", "Hospital 8 - Emergency", "Hospital 9 - Diagnostic", "Hospital 10 - Community"],
		"department_names": [
			"Network Operations",
			"Emergency",
			"ICU",
		...
		"seasonality": "Network-wide continuous operations with load balancing between facilities, centralized procurement cycles, inter-facility patient transfers.",
		"monthly_weights": [0.08, 0.08, 0.08, 0.08, 0.09, 0.09, 0.09, 0.09, 0.08, 0.09, 0.08, 0.08],
		"kpi_focus": ["Network Utilization", "Inter-Hospital Transfers", "Central Procurement Savings", "Bed Occupancy Network", "Patient Satisfaction Network"],
		"report_profiles": [
			"Network-wide utilization dashboard",
			"Hospital performance comparison",
			"Inter-facility transfer analysis",
			"Central procurement savings report",
			"Network patient flow metrics",
		],
		"sample_data_seed": {
			**BASE_SAMPLE_DATA_SEED,
			"employees": 1200,
	...
	},
	{
		...
		"template_name": "Hotel Asset Management - Annual Demo",
		"description": "Twelve-month hotel fixed-asset demo with 200 tagged assets, multi-property structure, inspections, transfers, RFID scans, and depreciation workflows.",
		"branch_count": 4,
		"employee_count": 95,
		"customer_count": 120,
		"supplier_count": 85,
		"transactions_per_month": 110,
		"business_activity": "Hotel Assets",
		"industry_sector": "Hotel Assets (إدارة أصول الفنادق)",
		"branch_names": [
			"Head Office",
		...
		"seasonality": "Steady operations with seasonal occupancy peaks; preventive maintenance cycles and asset inspections run year-round.",
		"monthly_weights": [0.07, 0.07, 0.08, 0.09, 0.09, 0.10, 0.11, 0.11, 0.09, 0.08, 0.06, 0.05],
		"kpi_focus": [
			"Asset Utilization",
		...
		"report_profiles": [
			...
			"Hotel asset depreciation summary",
		],
		"sample_data_seed": {
			**BASE_SAMPLE_DATA_SEED,
			"assets": 200,
	...
	},
	{
		...
		"template_name": "Law Firm - Annual Demo",
		"description": "Twelve-month law firm demo with clients, matters, cases, lawyers, hearings, consultations, client intake, and billing workflows.",
		"branch_count": 3,
		"employee_count": 45,
		"customer_count": 120,
		"supplier_count": 40,
		"transactions_per_month": 90,
		"business_activity": "Legal",
		...
		"seasonality": "Matter-driven billing with court calendar peaks in Q1 and Q4; steady advisory work year-round.",
		"monthly_weights": [0.09, 0.08, 0.08, 0.08, 0.08, 0.08, 0.07, 0.07, 0.08, 0.09, 0.10, 0.10],
		"kpi_focus": [
			"Billable Hours",
			"Active Matters",
			"Collection Rate",
