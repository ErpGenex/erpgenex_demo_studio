#!/usr/bin/env python3
"""Audit company/branch scoping — erpgenex_demo_studio."""
...
def run():
	...
	return {"ok": True, "app": "erpgenex_demo_studio", "company": company, "branch": branch, "uses_session_context": bool(company)}
